...
class Goods(models.Model):
    ...
    spu = models.ForeignKey('goods.SPU', on_delete=models.CASCADE, related_name='all_skus', verbose_name='店铺',
                            null=True)
    sku = models.CharField(max_length=20, verbose_name='商品sku', null=True)
    title = models.CharField(max_length=100, verbose_name='商品名称')
    slogan = models.CharField(max_length=150, verbose_name='标语', null=True)
    ...
    videoUrl = models.CharField(max_length=250, verbose_name='视频封面', null=True)
    videoImage = models.CharField(max_length=250, verbose_name='视频链接', null=True)
    playTime = models.CharField(max_length=10, verbose_name='播放时长')
    goodsImageUrls = models.JSONField(verbose_name="商品图片", null=True)
    goodsCertificateUrls = models.JSONField(verbose_name="商品资质", null=True, default=list)
    defaultImageUrl = models.CharField(max_length=250, verbose_name="商品图片", null=True)
    ...
    selectedClassifyList = models.JSONField(verbose_name="商品分组", null=True, default=list)
    ...
    selectedGoodsRightsList = models.JSONField(verbose_name="商品服务", null=True, default=list)
